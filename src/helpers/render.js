...
var tokenPattern = new RegExp((function () {
    ...
    for (var key in tokens) {
        var _a = tokens[key], start = _a.start, content = _a.content, stop_1 = _a.stop;
        delimiters.push("(?<" + key + ">" + start.source + ((content === null || content === void 0 ? void 0 : content.source) || '') + ((stop_1 === null || stop_1 === void 0 ? void 0 : stop_1.source) || '') + ")");
    }
