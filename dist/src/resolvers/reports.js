...
function getReports(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            // Fetch the reports.
            return [2 /*return*/, globals_1.prisma.report.findMany(query)];
        });
    });
}
...
function addReport(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, globals_1.prisma.report.create({
                        data: {
...
function deleteReport(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, globals_1.prisma.report["delete"]({
                        where: {
                            id: params.reportId
                        }
                    })];
